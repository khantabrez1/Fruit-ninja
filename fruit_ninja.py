...
WIDTH = 800
HEIGHT = 500
FPS = 10                                             #controls how often the gameDisplay should refresh. In our case, it will refresh every 1/10th second
pygame.init()
...
def generate_random_fruits(fruit):
    ...
    data[fruit] = {
        ...
        'speed_y': random.randint(-90, -70),    #control the speed of fruits in y-directionn ( UP )
